...
::: notes
Contribuer avec github, montrer le github, dire que sur le read me conseils pour contribuer et mettre des codes, espace de partage de codes à venir
:::

# Et vous, quels sont vos usages de MiDAS ? 👁️‍🗨️

::: notes
Utilisation midas, études
:::
...
::: notes
opérations impossibles ? bugs erreurs insolubles ? Déjà utilisé spark ?
:::
...
::: notes
Plusieurs ordinateurs, noter le voc au tableau noeud = worker = ordinateur = datanode = executeur = instance Session dans la bulle donc charger grosses données en session = limité par la taille de la bulle
:::
...
## Quizz : traitement nomal ou traitement très lourd {.smaller}
...
## Chargement des données en spark {.smaller}
...
## Optimiser la configuration des exécuteurs {.smaller}
